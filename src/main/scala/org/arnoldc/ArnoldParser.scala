...
class ArnoldParser extends Parser {
  ...
  val ParseError = "I HAN WAS FALSCH GEMACHT"

  val DeclareInt = "1 KURZER"
  val SetInitialValue = "VONG WERT HER"
  val BeginMain = "I BIMS"
  val PlusOperator = "SCHENK EIN"
  val MinusOperator = "SAUF AUS"
  val MultiplicationOperator = "DOUBLE TIME"
  val DivisionOperator = "DURCH"
  val EndMain = "I BIMS NIMMER"
  val Print = "RED MIT DEM KOMPUTER"
  val Read = "I KAN NED LESEN"
  val AssignVariable = "ÜBERSCHREIB MI"
  val SetValue = "MIT DEM HIER VONG VALUE HER"
  val EndAssignVariable = "I BIMS ÜBERSCHRIEBEN"
  val False = "NED RICHTIG"
  val True = "TRU THAT"
  val EqualTo = "GLEICH VONG STYLE"
  val GreaterThan = "GRÖSER VONG STYLE"
  val Or = "ODA"
  val And = "BEIDES"
  val If = "WENG"
  val Else = "SONST"
  val EndIf = "STOP"
  val While = "I LAUF SO LANGE WIE"
  val EndWhile = "JETZ STOP I"
  val DeclareMethod = "I BIMS 1 METHODE"
  val MethodArguments = "GIB MIR 1"
  val Return = "I HAN 1 RÜCKGABE FÜR DI"
  val EndMethodDeclaration = "I BIMS NIMMER 1 METHODE"
  val CallMethod = "LAUF"
  val NonVoidMethod = "I BIMS KEIN VOID"
  val AssignVariableFromMethodCall = "GIB MIR 1 WERT VONG 1 MEHTODE"
  val Modulo = "I HAN KEINS AHNUNG WIE MAN DAS HERNIMMT"
